        ...
        <head>
            ...
            <section class="guitar">
                ...
                <div class="product">
                    ...
                    <img src="https://godinguitars.com/wp-content/uploads/2020/10/49479_Multiac_Grand_Concert_Deluxe.jpg" alt="Acústica Grand Concert"> <button class="btn" type="button" id="myBtn_3">Select</button>
                </div>
                <div class="product">
            ...
            <script type= "module" src="../js/confirmAcustic.js"></script>
        </body>
    </html>