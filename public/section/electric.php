    ...
    <html lang="en">
        <head>
            ...
            <section class="guitar">
                ...
                <div class="product">
                    <div class="level">Telecaster</div>
                ...
                <div class="product">
                    <div class="level">Superstrat</div>
                    <img src="https://images-na.ssl-images-amazon.com/images/I/71TFu4WSHML._AC_SL1500_.jpg" alt="Superstrat"> 
                    <button class="btn" type="button" id="myBtn_2">Select</button>
                </div>
                <div class="product">
                    <div class="level">Semi-acoustic</div>
                    <img src="https://d1aeri3ty3izns.cloudfront.net/media/38/383117/1200/preview.jpg" alt="Semi-acoustic guitar"> <button class="btn" type="button" id="myBtn_3">Select</button>
                </div>
                <div class="product">
            ...
            <script type= "module" src="../js/confirmElectric.js"></script>
        </body>
    </html>