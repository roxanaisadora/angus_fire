...
<body translate="no">
    <div id="page-wrapper">
        ...
        <div class="container">
            <section id="data">
                <h1> Welcome, nice to have you here 😊</h1>
        ...
        <div class="container">
            ...
            <div class="title--works">
                <h1 > ʕ•́ᴥ•̀ʔっ Learn more about our work ...</h1>
                <p> Look at the different guitar classes we have for you.</p>
            </div>
            <section id="how-it-works">
                <iframe width="900" height="506" src="https://www.youtube.com/embed/dbYWi_X3Uio" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>                
            </section>
            <section id="pricing">
                <div class="product">
            ...
            <section id="survey" class="container-form">
                <h1 id="title" class="text-center">(っ◔◡◔)っ Contact us ...</h1>
                <p id="description" class="description">
                    Contact us if you have any questions or problems with the product
                </p>
                <form id="survey-form">
